...
//     // magnifier.style.backgroundImage = `url(${`data:image/jpeg;base64,${selectedImage}`})`;
...
//             <img src="path-to-color1.jpg" alt="Color 1" />
//             <img src="path-to-color2.jpg" alt="Color 2" />
//             <img src="path-to-color3.jpg" alt="Color 3" />
//             <img src="path-to-color4.jpg" alt="Color 4" />
//           </div>
//         </div>
...
//             <button className="size disabled">3XL</button>
//           </div>
//         </div>
...
//             <li>Bank Offer Flat ₹1000 off on HDFC Bank Credit Card EMI Txns, Tenure: 6 and 9 months, Min Txn Value: ₹15,000 T&C</li>
//             <li>Bank Offer Flat ₹1250 off on HDFC Bank Credit Card EMI Txns, Tenure: 12 and 18 months, Min Txn Value: ₹15,000 T&C</li>
//             <li>Partner Offer Make a purchase and enjoy a surprise cashback/ coupon that you can redeem later! Know More</li>
...
//           <span>Delivery by <strong>4 Aug, Sunday</strong> | Free <strong>₹40</strong> if ordered before 8:34 PM</span>
        ...
        <div className="color-options">
          ...
          <div className="color-thumbnails">
            {product.productVariants?.map((variant, index) => (
              <img
                key={index}
                src={`data:image/jpeg;base64,${variant.image[0]}`} // Assuming image[0] is the first image
                alt={`Color ${index + 1}`}
              />
            ))}
          </div>
